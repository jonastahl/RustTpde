...
// x86-64 has no `cmp r64, imm64` -- CMP64ri takes an imm32 that the CPU
// sign-extends to 64 bits. These three bracket that encoding limit: the first
// immediate fits in a sign-extended imm32, the other two do not and have to be
